class Platform < List
  ...
  add_checklist_family :projects, 'projects_count >= %{n}', labels: { 1 => 'Add your first project (and approved it)', n: 'Reach %{n} projects' }, thresholds: [1, 10, 50, 100, 500, 1_000, 5_000, 10_000, 50_000, 100_000, 500_000, 1_000_000], groups: { 1 => :get_started, 10 => :featured, n: :next_level }, goto: 'new_project_path(platform_tags_string: @platform.name)'
