class ProjectsController < ApplicationController
  ...
  def next
    if !params[:ref_id] or !params[:ref]
    ...
    if @next
      redirect_to project_path(@next, ref: params[:ref], ref_id: params[:ref_id], offset: offset)
    else
      redirect_to project_path(BaseArticle.magic_sort.first, ref: params[:ref], ref_id: params[:ref_id], offset: params[:offset])
    end
  end
