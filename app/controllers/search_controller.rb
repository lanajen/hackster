class SearchController < ApplicationController
  ...
  def tags
    ...
    begin
      ...
      @projects = Project.indexable.joins("INNER JOIN tags ON tags.taggable_id = projects.id AND tags.taggable_type = 'Project'").where(tags: { type: %w(ProductTag PlatformTag) }).where("LOWER(tags.name) = ?", @tag.downcase)
