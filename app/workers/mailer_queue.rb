class MailerQueue < BaseWorker
  ...
  def devise_message type, context_type, context_id, opts
    ...
    deliver_email(type, context_type, context_id, opts)
  end
  ...
  def message_with_context type, context_type, context_id
    ...
    deliver_email(type, context_type, context_id)
  end
  ...
  def send_invites emails, user_id=nil
    user = User.find_by_id user_id
    f = FriendInvite.new emails: emails
    f.extract_emails
  ...
  private
    ...
    def deliver_email type, context_type, context_id, opts={}
