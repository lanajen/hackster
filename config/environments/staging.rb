HackerIo::Application.configure do
  ...
  config.assets.precompile += %w( admin.css wysihtml5.css email.css wysihtml5/parser_rules.js jquery.githubRepoWidget.min.js bitbucket-widget.min.css bitbucket-widget.min.js thingiview.js slick.eot slick.svg slick.ttf slick.woff )
